...
description: "會使用到的套件: 主體: express - web framework body-parser - parse request body 測試相關: mocha - test framework mocha-mongoose - 用來和 mocha 和 mongoose 中間做介接的套件..."
date: 2014-10-18
categories: ['RESTful', 'API', 'Node.js', 'MongoDB', 'mocha superagent']
tags: ['鐵人賽']
---
