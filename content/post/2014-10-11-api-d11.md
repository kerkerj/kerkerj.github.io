...
description: "今天先講在 Server 中如何操作 MongoDB 一樣開啟虛擬機， 我們在先前已經有先安裝過 MongoDB 了，因此，在 Ubuntu Server 中預設是開機啟動的 登入虛擬機吧 登入虛擬機後，我們要進入 MongoDB，必須使用 mongo 這個 MongoDB Shell $..."
date: 2014-10-11
