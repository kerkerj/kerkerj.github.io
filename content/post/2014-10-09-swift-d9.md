...
description: "Playground - Class, Struct 再來就是要提重點的東西了! class 和 struct 是用來建構整個程式重要的東西 兩者的差異在於：class 可以繼承其他 class，但是 struct 無法繼承 以下是宣告方式 swift class SomeClass { //..."
date: 2014-10-09
categories: ['Swift']
tags: ['鐵人賽']
---
